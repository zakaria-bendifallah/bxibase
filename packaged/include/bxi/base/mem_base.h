...
#ifndef BXIMEM_BASE_H_
#define BXIMEM_BASE_H_
 ...
 * @see bximem_destroy()
 */
#define _BXIFREE(pointer) _bximem_destroy((char**) &(pointer))
 ...
 */
void * _bximem_realloc(void *ptr, size_t old_size, size_t n);
 ...
 *                or _bximem_calloc() or _bximem_realloc().
 * @see _bximem_calloc()
 */
